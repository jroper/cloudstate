module github.com/cloudstateio/cloudstate/cloudstate-operator
...
require (
	...
	istio.io/api v0.0.0-20200117012539-9fcdbdc64940 // indirect
	istio.io/client-go v0.0.0-20200110194818-501989d1909c
